...
// User user1 = new User(1L, "Nalbert Wattam", "nalbertwattam",
// "nalbertwattam@gmail.com", "password1");
// User user2 = new User(2L, "Rust Cohle", "rustcohle", "rustcohle@gmail.com",
// "password2");
// User user3 = new User(3L, "Martin Hart", "martinhart",
// "martinhart@gmail.com", "password3");
...
// "A REST API to manage serial killers on Erath, Louisiana", Status.OPEN,
// user2);
...
// "When trying to update a book the error \"Method Not Allowed\" (code 405) is
// throw",
...
// Status.OPEN, project2,
// user2, "22/05/1995 13:50", "25/05/2012 21:30", null));
// bugRepository.save(
// new Bug(3L, "Unable to delete a coffee shop",
// "When trying to delete a coffee shop it says that it was deleted, but it
// wasn't", Status.CLOSED,
// project3, user3, "11/01/2012 09:50", "13/01/2012 11:50", "14/01/2012
// 08:30"));
// }
